...
REPORT_TEX = os.path.join(REPORTDIR, "output_slow", "{file_name}_k{k}ma{min_abundance}t{threads}nm{non_maximal}th{threshold}", "{report_name}", "{report_file_name}.tex")
REPORT_TEX_FAST = os.path.join(REPORTDIR, "output", "{file_name}_k{k}ma{min_abundance}t{threads}nm{non_maximal}th{threshold}", "{report_name}", "{report_file_name}.tex")
...
rule download_flowtigs_without_filtering:
    ...
    shell:  """
        ...
        git clone https://github.com/elieling/flowtigs
        cd flowtigs
        git checkout 1b6c3ff9b482b242d350962625dbb0d2fa0e1917
